...
from custom_loss import rescale_true_corr, rescale_sigmoid
...
pred_fname = "/home2/ayh8/data/lcl/merged_orientation_index_logits_rescale_true_0.npz"
...
pearsonr(expt_orientation.to_numpy().astype(np.float32), rescale_sigmoid(pred_orientation.flatten()))
rescale_true_corr(expt_orientation.to_numpy().astype(np.float32), pred_orientation.flatten()).numpy()
